...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers("/bookview", "/bookview/success", "/bookview/error").permitAll().antMatchers("/user**")
				.access("hasRole('EMPLOYEE') and hasRole('ADMIN')").antMatchers("/admin**", "/accountAdmin")
